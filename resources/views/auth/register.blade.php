						...
						<div class="card-body">
							...
							<form method="POST" class="my-login-validation" autocomplete="off" action="{{ route('register') }}">
								...
								<div class="form-group">
									...
									<input id="mobile" type="text" class="form-control" name="mobile" autofocus placeholder="Enter Mobile No." value="{{ old('mobile') }}">
								...
								<div class="form-group">
									...
									<input id="city" type="text" class="form-control" name="city" autofocus placeholder="Enter City" value="{{ old('city') }}">
									<span class="text-danger">@error('city'){{ $message }}@enderror</span>
								</div>

								<div class="form-group">
									<label for="gender">Gender</label>
									<input id="gender" type="text" class="form-control" name="gender" autofocus placeholder="Enter Gender" value="{{ old('gender') }}">
